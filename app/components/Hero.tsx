  ...
  return (
    <main className="container mx-auto pt-20 flex flex-col lg:flex-row items-center md:justify-between lg:px-0 px-6">
      <div className="flex gap-8 flex-col w-12/12 lg:w-6/12 items-start mb-20 lg:mb-0">
        ...
        <a href="https://wa.me/5562981602934?text=Ol%C3%A1%2C%20queria%20saber%20mais%20sobre%20seus%20servi%C3%A7os." target="_blank" className="flex items-center gap-6 basis-0 bg-app-purple p-5 border-[3px] border-black hover:shadow-app-black transition-all duration-500 rounded-[30px] group font-bold">
